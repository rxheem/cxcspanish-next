...
var Overview = function Overview(props) {
  ...
  }, "Composition"), ". However, if you choose to do this question is is important to know what is required and how your letter is to be structured."), __jsx("br", null), __jsx("p", null, "You will be given a template or a scenario in which you should compose your letter, which should"), __jsx("br", null), __jsx("ul", null, __jsx("li", null, __jsx(react_fontawesome__WEBPACK_IMPORTED_MODULE_1___default.a, {
    name: ""
  })))), __jsx("div", {
    className: "box"
  }, __jsx("p", null, "Yes")));
...
//# sourceMappingURL=letter-writing.js.8ea5a754e28b167b19c1.hot-update.js.map