...
var Overview = function Overview(props) {
  return __jsx("div", null, __jsx("div", {
    ...
    text: __jsx(Fragment, null, "You attend a benefit concert at which a famous Caribbean artiste performed. Write a letter to your best friend who lives in Argentina describing your experience. Be sure to include:", __jsx("br", null), __jsx("br", null), __jsx("ul", null, __jsx("li", null, "when the concert was held and the name of the artiste"), __jsx("li", null, "a description of the mood or the atmosphere on the night of the concert"), __jsx("li", null, "what you liked and/ or disliked about the concert"), __jsx("li", null, "how the proceeds from the concert will be used.")))
  })));
};
...
//# sourceMappingURL=letter-writing.js.63712bf582c6fbde57b0.hot-update.js.map