...
class ContextualDialogue extends React.Component {
  componentDidMount() {}
  ...
  render() {
    return (
      <Layout>
        <Head>
          <title>Contextual Dialogue | CXC Spanish Guide</title>
          <meta
            name="description"
        ...
        <h1 className="title is-5">Contextual Dialogue</h1>
...
export default ContextualDialogue;
